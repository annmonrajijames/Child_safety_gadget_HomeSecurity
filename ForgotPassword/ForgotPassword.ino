...
byte rowPins[ROWS] = {D0, D1, D2, D3}; // Connect keypad ROW0, ROW1 and ROW3 to these pins respectively.
byte colPins[COLS] = {D4, D5, D6}; // Connect keypad COL0, COL1 and COL2 to these pins respectively.
