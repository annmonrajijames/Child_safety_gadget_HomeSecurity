...
const char* ssid     = "Annmon";   //your network SSID
const char* password = "childsafe";   //your network password
int IRpin = 13;
int state = LOW;
String myScript = "/macros/s/AKfycbwRq2UN0UBWjNNSTxKbNhg9s0QdkiTfj-ZjxVPTDV8Kx3XdGloIgehjIuBYML9iL3tq/exec";    //Create your Google Apps Script and replace the "myScript" path.
